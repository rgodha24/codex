...
use agent_client_protocol::McpCapabilities;
...
use agent_client_protocol::SessionCapabilities;
use agent_client_protocol::SessionId;
use agent_client_protocol::SessionInfo;
use agent_client_protocol::SessionListCapabilities;
use agent_client_protocol::SetSessionConfigOptionRequest;
...
impl Agent for CodexAgent {
    ...
    async fn new_session(&self, request: NewSessionRequest) -> Result<NewSessionResponse, Error> {
        ...
        debug!("Created new session with {num_mcp_servers} MCP servers");
