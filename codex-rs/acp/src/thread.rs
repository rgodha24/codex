...
use codex_core::protocol::ExecCommandStatus;
...
use codex_core::protocol::ModelRerouteEvent;
use codex_core::protocol::Op;
use codex_core::protocol::PatchApplyBeginEvent;
use codex_core::protocol::PatchApplyEndEvent;
use codex_core::protocol::PatchApplyStatus;
...
use crate::prompt_args::expand_custom_prompt;
            ...
            .request_permission(
                ToolCallUpdate::new(
                    ...
                    ToolCallUpdateFields::new()
                        ...
                        .title(title)
                        .locations(locations)
                        .content(content.chain(reason.map(std::convert::Into::into)).collect::<Vec<_>>())
                        .raw_input(raw_input),
                ),
                vec![
